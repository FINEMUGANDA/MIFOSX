...
public class LoanProductToGLAccountMappingHelper extends ProductToGLAccountMappingHelper {
    ...
    public Map<String, Object> populateChangesForNewLoanProductToGLAccountMappingCreation(final JsonElement element,
        ...
        final Long LPIWriteOffAccountId = this.fromApiJsonHelper.extractLongNamed(
                LOAN_PRODUCT_ACCOUNTING_PARAMS.LPI_WRITTEN_OFF.getValue(), element);
...
//            final Long feeWriteOffAccountId
        switch (accountingRuleType) {
            ...
            case ACCRUAL_PERIODIC:
                populateChangesForAccrualBasedAccounting(changes, fundAccountId, loanPortfolioAccountId, incomeFromInterestId,
                        ...
                        LPIWriteOffAccountId, interestWriteOffAccountId, feeWriteOffAccountId, unidentifiedDepositsAccountId, unidentifiedProfitAccountId);
            break;
    ...
    private void populateChangesForAccrualBasedAccounting(final Map<String, Object> changes, final Long fundAccountId,
            ...
            final Long feeWriteOffAccountId, final Long unidentifiedDepositsAccountId, final Long unidentifiedProfitAccountId) {
        ...
        changes.put(LOAN_PRODUCT_ACCOUNTING_PARAMS.UNIDENTIFIED_PROFIT.getValue(), unidentifiedProfitAccountId);
    ...
    private void populateChangesForCashBasedAccounting(final Map<String, Object> changes, final Long fundAccountId,
        ...
        changes.put(LOAN_PRODUCT_ACCOUNTING_PARAMS.PRINCIPAL_WRITTEN_OFF.getValue(), writeOffAccountId);
    ...
    public void handleChangesToLoanProductToGLAccountMappings(final Long loanProductId, final Map<String, Object> changes,
        ...
        switch (accountingRuleType) {
            ...
            case CASH_BASED:
                ...
                // expenses
                mergeLoanToExpenseAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.PRINCIPAL_WRITTEN_OFF.getValue(),
            ...
            case ACCRUAL_PERIODIC:
                ...
                mergeLoanToIncomeAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.UNIDENTIFIED_PROFIT.getValue(),
                        loanProductId, ACCRUAL_ACCOUNTS_FOR_LOAN.UNIDENTIFIED_PROFIT.getValue(),
                        ACCRUAL_ACCOUNTS_FOR_LOAN.UNIDENTIFIED_PROFIT.toString(), changes);

                // expenses
                mergeLoanToExpenseAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.PRINCIPAL_WRITTEN_OFF.getValue(),
                        loanProductId, ACCRUAL_ACCOUNTS_FOR_LOAN.PRINCIPAL_WRITTEN_OFF.getValue(),
                        ACCRUAL_ACCOUNTS_FOR_LOAN.PRINCIPAL_WRITTEN_OFF.toString(), changes);
                mergeLoanToExpenseAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.LPI_WRITTEN_OFF.getValue(),
                        loanProductId, ACCRUAL_ACCOUNTS_FOR_LOAN.LPI_WRITTEN_OFF.getValue(),
                        ACCRUAL_ACCOUNTS_FOR_LOAN.LPI_WRITTEN_OFF.toString(), changes);
                ...
                mergeLoanToExpenseAccountMappingChanges(element, LOAN_PRODUCT_ACCOUNTING_PARAMS.FEES_WRITTEN_OFF.getValue(),
                        loanProductId, ACCRUAL_ACCOUNTS_FOR_LOAN.FEES_WRITTEN_OFF.getValue(),
