...
@Service
public class UpdateCostCenterCommandHandler implements NewCommandSourceHandler {

    private final CostCenterWritePlatformService writePlatformService;

    @Autowired
    public UpdateCostCenterCommandHandler(final CostCenterWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.writePlatformService.updateCostCenter(command.entityId(), command);
    }
}