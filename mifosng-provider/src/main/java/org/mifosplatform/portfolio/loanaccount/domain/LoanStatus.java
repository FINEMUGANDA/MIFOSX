...
public enum LoanStatus {
	...
	ACTIVE(300, "loanStatusType.active"), // deprecated
	...
	CLOSED_WRITTEN_OFF_BALANCE_RECOVERED(603, "loanStatusType.closed.written.off.balance.recovered"), //
	...
	public static LoanStatus fromInt(final Integer statusValue) {
		...
		switch (statusValue) {
			...
			case 602:
				...
				break;
			case 603:
				enumeration = LoanStatus.CLOSED_WRITTEN_OFF_BALANCE_RECOVERED;
				break;
			case 700:
