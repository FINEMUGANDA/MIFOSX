...
public class FinancialYearCannotBeCreatedException extends AbstractPlatformDomainRuleException {
    ...
    public FinancialYearCannotBeCreatedException(final LOAN_COLLATERAL_CANNOT_BE_CREATED_REASON reason, final Long loanId) {
