...
public class FinancialYearCannotBeDeletedException extends AbstractPlatformDomainRuleException {
    ...
    public FinancialYearCannotBeDeletedException(final LOAN_COLLATERAL_CANNOT_BE_DELETED_REASON reason, final Long loanId,
