...
public enum JobName {
    ...
    EXPIRED_LOAN_PAYMENT_REMINDER_EMAIL_NOTIFICATION("Expired Loans Payment Reminder Email Notification"),
    EXPIRED_LOAN_PAYMENT_REMINDER_SMS_NOTIFICATION("Expired Loans Payment Reminder SMS Notification"),
