...
public abstract class AbstractNotificationService implements NotificationService {
    ...
    protected static final String queryFollowUpOfficers = "SELECT n.createdByUserName AS username,u.email, u.firstname, u.lastname FROM notes n, m_appuser u WHERE n.createdByUserName=u.username AND n.followUpDate = CURRENT_DATE() GROUP BY email, firstname, lastname";
